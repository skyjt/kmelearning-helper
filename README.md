...
- 📋 登录首页后自动检测待学项目，在浮窗中显示项目列表。
- ✅ 选择项目后先二次确认，再自动进入项目详情和课程目录。
- 🪟 在学习目录页显示“学习助手”浮窗，并实时显示当前目录的**课程进度**。
...
完整记录见 [CHANGELOG.md](CHANGELOG.md)。最近一次更新（**v2.10.0**）：统一浮窗层级术语——首页显示「待学项目」、进入后显示「课程进度 x/y」，首页隐藏无效的大按钮并在任务区新增「刷新」，消除“1 个任务点进去变 2 个”的困惑。
